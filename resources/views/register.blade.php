        ...
        <div class="card card-login" style="width: 40rem;">
            <div class="card-body">
                ...
                <div class="form-floating mb-3">
                    <input disabled type="email" class="form-control" id="floatingInput" placeholder="Admin/Pewawancara">
                ...
                <div class="d-grid">
                    <button class="btn btn-login text-uppercase fw-bold" style="background-color:#E48700; color:white" type="submit">Register</button>
                </div>
                </form>
            </div>
        </div>
