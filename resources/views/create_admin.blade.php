        ...
        <div class="card-body">
            ...
            <form action="/create-admin" method="post">
                ...
                <div class="form-group">
                    <label for="exampleFormControlInput1">Pilih Peminatan dari Admin </label>
                    <select name="profesi">
                ...
                <div class="d-grid">
                    <button class="btn btn-login text-uppercase fw-bold" style="background-color:#E48700; color:white"
                        type="submit">Register</button>
                    <a class="btn btn-outline-dark text-uppercase fw-bold my-3" type="button"
                        href="{{route('daftar_admin')}}">Back</a>
                </div>
            </form>
        </div>
    </div>
