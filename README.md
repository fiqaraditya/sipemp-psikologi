...
```
cd existing_repo
git remote add origin https://gitlab.cs.ui.ac.id/propensi-fasilkom-ui/2022/kelas-d/d09.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.ui.ac.id/propensi-fasilkom-ui/2022/kelas-d/d09/-/settings/integrations)
